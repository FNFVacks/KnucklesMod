...
function onBeatHit()
    ...
    if curBeat == 128 and songName == "scrambled" then   --this is custom code for the scrambled cutscene which should hopefully only run in scrambled so this same script can go reused in misfit mania, if not, thats alright i'll just change it up for misfit mania and all that
        skipDance = true
    elseif curBeat == 231 and songName == "scrambled" then
        skipDance = false
    end
end
