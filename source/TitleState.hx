...
class TitleState extends MusicBeatState
{
	...
	var tweenGfDance:FlxTween;
	var tweenTitleText:FlxTween;
	var tweenLogoBl:FlxTween;
	...
	function startIntro()
	{
		...
		swagShader = new ColorSwap();
		gfDance = new FlxSprite(titleJSON.gfx + 700, titleJSON.gfy);
		...
		titleText = new FlxSprite(titleJSON.startx, titleJSON.starty + 200);
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
			    ...
			    //FlxTween.tween(FlxG.camera, { zoom: 1 }, 1, { ease: FlxEase.cubeInOut });
		...
		FlxG.camera.zoom = FlxMath.lerp(1, FlxG.camera.zoom, CoolUtil.boundTo(1 - (elapsed * 3.125 * 1.2), 0, 1));
