...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		//healthBar.createGradientBar([FlxColor.fromRGB(dad.healthColorArray[0], dad.healthColorArray[1], dad.healthColorArray[2]), FlxColor.PURPLE], [FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]),FlxColor.CYAN], 1, -90, false);
	...
	function cacheCountdown()
	{
		...
		introAssets.set('default', ['ready', 'get', 'set', 'go']);
		introAssets.set('pixel', ['pixelUI/ready-pixel', 'pixelUI/get-pixel', 'pixelUI/set-pixel', 'pixelUI/date-pixel']);
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				switch (swagCounter)
				{
					...
					case 1:
						countdownGet = new FlxSprite().loadGraphic(Paths.image(introAlts[1]));
	...
	override public function update(elapsed:Float)
	{
		...
		var mult:Float = FlxMath.lerp(1, iconP1.scale.x, CoolUtil.boundTo(1 - (elapsed * 12 * playbackRate), 0, 1)); // was 9
		iconP1.scale.set(mult, mult);
		iconP1.updateHitbox();

		var mult:Float = FlxMath.lerp(1, iconP2.scale.x, CoolUtil.boundTo(1 - (elapsed * 12 * playbackRate), 0, 1)); // was 9
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		if(ClientPrefs.ratingCamera == 'HUD')
		{
			rating.cameras = [camHUD];
			rating.x = coolText.x - 40;
			rating.y -= 60;
		...
		else if(ClientPrefs.ratingCamera == 'Game')
		{
